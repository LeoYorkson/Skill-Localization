...
def main():
    ...
    graft_trainer.create_basepatch_Gumbel() #! Gumbel based masking, here are all ones at the start
    ...
    if not training_args.no_train:
        ...
        #            data_args.task_name, \
        #           )
        graft_trainer.train_graft_Gumbel(train_dataloader, \
                    valid_dataloader, \
                    eval_dataset, \
                    data_args.autoregressive, \
                    data_args.task_name, \
                    )  #! Gumbel based masking
    ...
    graft_trainer.interpolate_model_Gumbel(round_=True) #! use Gumbel based interpolation 
